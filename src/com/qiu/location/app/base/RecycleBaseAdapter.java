...
public abstract class RecycleBaseAdapter<T> extends RecyclerView.Adapter<RecycleBaseAdapter.ViewHolder> {
    ...
    protected int state = STATE_NO_DATA;
    ...
    private void onBindFooterViewHolder(ViewHolder holder, int position) {
        ...
        switch (getState()) {
            ...
            case STATE_NO_DATA:
                ...
                vh.progress.setVisibility(View.GONE);
                vh.text.setVisibility(View.VISIBLE);
                vh.text.setText(AppContext.string(R.string.loading_no_data));
                break;
            case STATE_NETWORK_ERROR:
                vh.loadmore.setVisibility(View.VISIBLE);
                vh.progress.setVisibility(View.GONE);
